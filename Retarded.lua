...
function UI:UpdateScale()
	...
	retardedPanel.text:SetScale(Opt.scale.main)
	...
	retardedCooldownPanel.text:SetScale(Opt.scale.cooldown)
...
function UI:UpdateDisplay()
	...
	retardedCooldownPanel.text.center:SetText(text_cd_center)
	retardedCooldownPanel.text.tr:SetText(text_cd_tr)
end
