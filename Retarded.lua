...
function UI:UpdateDisplay()
	...
	if color_center ~= retardedPanel.text.center.color then
		retardedPanel.text.center.color = color_center
		if color_center == 'green' then
			retardedPanel.text.center:SetTextColor(0, 1, 0, 1)
		elseif color_center == 'red' then
			retardedPanel.text.center:SetTextColor(1, 0, 0, 1)
		else
			retardedPanel.text.center:SetTextColor(1, 1, 1, 1)
		end
	end
